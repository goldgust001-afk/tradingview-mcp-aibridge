...
> **사용 전 바꿔야 할 것 1개**: `<YOUR_GITHUB_HANDLE>`을 실제 GitHub 계정/조직명으로 치환.
> 예: `AIBridge-Lab`, `leo-jin`, 등.
...
1. 현재 프로젝트 디렉토리 안에 https://github.com/<YOUR_GITHUB_HANDLE>/tradingview-mcp-aibridge.git 를 clone 해줘 (폴더명: tradingview-mcp-aibridge).
